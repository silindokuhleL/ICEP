		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				<article class="admin-dashboard">
					<h3 class="admin-welcome-title"><?php echo $_SESSION["name"] . ' ' . $_SESSION["lastname"];?> Welcome DOCTER SYSTEM</h3>
					<img src="images/chairsTwo.jpg" alt=" " class="img-responsive admin-image thumbnail">
				</article>
			</div>
		</div>
	</div>
